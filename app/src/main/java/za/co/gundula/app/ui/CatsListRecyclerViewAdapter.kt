...
internal class CatsListRecyclerViewAdapter(private val catsLIst: List<Cat>) : RecyclerView.Adapter<CatsListRecyclerViewAdapter.CatsViewHolder>() {

    var onClickSubject = PublishSubject.create<String>()
